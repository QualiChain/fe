...
export const environment = {
  ...
  jobsUrl : 'http://knowledgebizvpn.ddns.net/proxyKBZ/jobs',
  //jobsProfilesUrl : '/proxyKBZ/profiles',
  jobsProfilesUrl : 'http://knowledgebizvpn.ddns.net/proxyKBZ/profiles',
  skillsUrl : '/ntuaAPI5004/skills',
  specializationsURL : '/ntuaAPI5004/specializations',
  notificationsURL : '/ntuaAPI5004/notifications',
  //cvUrl : '/proxyKBZ/cv',
  cvUrl : 'http://knowledgebizvpn.ddns.net/proxyKBZ/cv',
  //skillsCV : '/proxyKBZ/skills',
  skillsCV : 'http://knowledgebizvpn.ddns.net/proxyKBZ/skills',
  //jobmatchingUrl : '/proxyKBZ/jobs',
  jobmatchingUrl : 'http://knowledgebizvpn.ddns.net/proxyKBZ/jobs',
  //jobpostUrl : '/proxyKBZ/jobs',
  jobpostUrl : 'http://knowledgebizvpn.ddns.net/proxyKBZ/jobs',
