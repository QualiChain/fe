...
export class AwardSmartBadgeComponent implements OnInit {
  ...
  */
  ...
  displayedColumns: string[] = ['student', 'grade', 'action'];
...
export class awardDialog_modal implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listOfSmartAwards = [
      {"@context":["https://w3id.org/openbadges/v2",{"@vocab":"https://blockchain.open.ac.uk/vocab/"}],"type":"BadgeClass","name":"new test","description":"this is another test","image":"https://qualichain-project.eu/quali-data/uploads/2019/04/training.png","version":"1","criteria":{"type":"Criteria","narrative":"The holder of this badge has achieved great things in QualiChain","skills":"skills"},"issuer":{"type":"Issuer","name":"Miquel","description":"this is the issuer desciption","url":"https://qualichain-project.eu/","email":"professor@tecnico.ulisboa.pt"}},
      {"@context":["https://w3id.org/openbadges/v2",{"@vocab":"https://blockchain.open.ac.uk/vocab/"}],"type":"BadgeClass","name":"other test","description":"this is a badge to check the content of the response","image":"https://qualichain-project.eu/quali-data/uploads/2019/04/training.png","version":"2","criteria":{"type":"Criteria","narrative":"The holder of this badge has achieved great things in QualiChain","skills":"skills"},"issuer":{"type":"Issuer","name":"Miquel","description":"just another test","url":"https://qualichain-project.eu/","email":"professor@tecnico.ulisboa.pt"}},
      {"@context":["https://w3id.org/openbadges/v2",{"@vocab":"https://blockchain.open.ac.uk/vocab/"}],"type":"BadgeClass","name":"a new Badge","description":"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.","image":"https://qualichain-project.eu/quali-data/uploads/2019/04/training.png","version":"1.0","criteria":{"type":"Criteria","narrative":"The holder of this badge has achieved great things in QualiChain","skills":"skills"},"issuer":{"type":"Issuer","name":"professor tecnico","description":"this is the issuer description","url":"https://qualichain-project.eu/news/","email":"professor@tecnico.ulisboa.pt","image":"https://qualichain-project.eu/quali-data/themes/qualichain/assets/img/qualichain-icon-white.png","telephone":"935558789"}},
      {"@context":["https://w3id.org/openbadges/v2",{"@vocab":"https://blockchain.open.ac.uk/vocab/"}],"type":"BadgeClass","name":"qwerty","description":"description querty","image":"https://qualichain-project.eu/quali-data/uploads/2019/04/lightbulb-150x150.png","version":"33","criteria":{"type":"Criteria","narrative":"The holder of this badge has achieved great things in QualiChain","skills":"skills"},"issuer":{"type":"Issuer","name":"professor","description":"this is my desscription","url":"https://qualichain-project.eu/news/","email":"professor@tecnico.ulisboa.pt","image":"https://qualichain-project.eu/quali-data/themes/qualichain/assets/img/qualichain-icon-white.png","telephone":"935558789"}}
    ];
    ...
    .getUser(this.data.userId).subscribe(
      dataUser => {
        ...
        let dataToPost = {
          ...
          "type":"BadgeClass",
          "name": dataBadgetStored.badge.badge.name,
          "description": dataBadgetStored.badge.badge.description,
          "image":  dataBadgetStored.badge.badge.image,
          "version":  dataBadgetStored.badge.badge.version,
          "criteria":  dataBadgetStored.badge.badge.criteria,
          "issuer": dataBadgetStored.badge.badge.issuer,
          "Assertion": {
            "type": "Assertion",
            "recipient": dataBadgetStored.badge.recipient
          },
          "issuedOn": dataBadgetStored.badge.issuedOn,
          "verification": dataBadgetStored.badge.verification,
          "signature": dataBadgetStored.badge.signature
        };
