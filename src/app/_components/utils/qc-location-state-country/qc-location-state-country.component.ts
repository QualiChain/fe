...
export class QcLocationStateCountryComponent implements OnInit {
  ...
  */
  //stateCountryOptions: Observable<StateCountryOption[]> = this.us.getCountryStates(countryValue);
  ...
  ngOnChanges(): void { 
    ...
    this.us
    .getStatesByCountry(this.countryValue)
    .subscribe((data: any[]) => {
      //console.log(data);
      this.stateCountryOptions = data;
